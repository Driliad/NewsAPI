...
function Body(body) {
  ...
  if (body == null) {
    ...
    body = null;
  } else if (typeof body === 'string') ;else if (isURLSearchParams(body)) ;else if (body instanceof Blob) ;else if (Buffer.isBuffer(body)) ;else if (Object.prototype.toString.call(body) === '[object ArrayBuffer]') ;else if (ArrayBuffer.isView(body)) ;else if (body instanceof _stream.default) ;else {
    // none of the above
    // coerce to string
    body = String(body);
  }
...
function consumeBody() {
  ...
  if (!(this.body instanceof _stream.default)) {
    return Body.Promise.resolve(Buffer.alloc(0));
  } // body is stream
...
var resolve_url = _url.default.resolve;
/**
 * Fetch function
 *
...
function () {
  ...
  _createClass(Loader, [{
    ...
    key: "postResp",
    value: function postResp(props) {
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {
        console.error('No callback for POST response');
      };
      var method = 'POST';
    ...
    value: function _errorHandler(res) {
      if (!res.ok) {
        if (res.status === 401 || res.status === 404) alert("Sorry, but there is ".concat(res.status, " error: ").concat(res.statusText));
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                method = _ref2.method, callback = _ref2.callback, props = _ref2.props;
                _context.prev = 1;
                _context.next = 4;
                return fetch(this.createUrl(props), {
                  method: method
                });
    ...
    key: "_fetchLoad",
    value: function _fetchLoad(_ref3) {
      var method = _ref3.method,
          callback = _ref3.callback,
          props = _ref3.props;
      fetch(this.createUrl(props), {
        method: method
      }).then(this._errorHandler).then(function (res) {
        return res.json();
      }).then(function (data) {
...
/*#__PURE__*/
function (_Loader) {
  _inherits(NewsAPILoader, _Loader);

  function NewsAPILoader() {
    _classCallCheck(this, NewsAPILoader);

    return _possibleConstructorReturn(this, _getPrototypeOf(NewsAPILoader).call(this, 'https://newsapi.org/v2/', {
...
var AppController =
/*#__PURE__*/
function (_NewsAPILoader) {
  _inherits(AppController, _NewsAPILoader);
  ...
  _createClass(AppController, [{
    key: "getSources",
    value: function getSources(callback) {
    ...
    value: function getNews(e, callback) {
      ...
      while (target != sourcesContainer) {
        if (target.classList.contains('source__item')) {
          var sources = target.getAttribute('data-source-id');
...
function () {
  ...
  _createClass(AppView, [{
    key: "drawNews",
    value: function drawNews(data) {
      this.news.draw(data.articles);
    }
  }, {
    key: "drawSources",
    value: function drawSources(data) {
  ...
  _createClass(App, [{
    ...
    value: function start() {
      ...
      document.querySelector('.sources').addEventListener('click', function (e) {
        return _this.controller.getNews(e, function (data) {
          return _this.view.drawNews(data);
        });
      });
      this.controller.getSources(function (data) {
        return _this.view.drawSources(data);
      });
    }
  }]);
